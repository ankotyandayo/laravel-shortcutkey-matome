                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        <div class="p-2 w-1/4">
                                            <div class="relative">
                                                ...
                                                <input type="text" id="key_1" name="key_1" value="{{ old('key_1') }}"
                                        ...
                                        <div class="p-2 w-1/4">
                                            <div class="relative">
                                                ...
                                                <input type="text" id="key_2" name="key_2" value="{{ old('key_2') }}"
                                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            </div>
                                        </div>
                                        <div class="p-2 w-1/4">
                                            <div class="relative">
                                                ...
                                                <input type="text" id="key_3" name="key_3" value="{{ old('key_3') }}"
                                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            </div>
                                        </div>
                                        <div class="p-2 w-1/4">
                                            <div class="relative">
                                                ...
                                                <input type="text" id="key_4" name="key_4" value="{{ old('key_4') }}"
                                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            </div>
                                        </div>
